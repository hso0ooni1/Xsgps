...
public final class XsGpsLocationService extends Service {
    static final String START="com.xsgps.embed.START";
    static final String STOP="com.xsgps.embed.STOP";
    ...
    private Notification notification(){
        ...
        if(i==null)i=new Intent(android.provider.Settings.ACTION_LOCATION_SOURCE_SETTINGS);
        ...
        return new Notification.Builder(this,CHANNEL).setSmallIcon(android.R.drawable.ic_menu_mylocation)
           .setContentTitle("XsGPS: موقع تجريبي").setContentText("محاكاة موقع اختبارية نشطة")
